...
public class ChaosRecyclerView extends RecyclerView {
    ...
    public ChaosRecyclerView(Context context) {
        this(context,null);
    }

    public ChaosRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ChaosRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mDeleteBtnState == 0) {
                    ...
                    //顶置按钮
                    mStatus = (TextView) mItemLayout.findViewById(R.id.tv_status);
                    //最大滑动距离
                    mMaxLength = mDelete.getWidth()+mStatus.getWidth();
                    ...
                    mStatus.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            //分享后 滑回开始位置
                            mListener.onSignClick(mPosition);
                            mItemLayout.scrollTo(0,0);
                            mDeleteBtnState = 0;
                        }
                    });
